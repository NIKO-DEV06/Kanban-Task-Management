  ...
  return (
    <>
      <header className="fixed md:flex justify-between items-center w-full h-[6rem] p-[1.5rem] hidden bg-white border-b border-[#E4EBFA] px-[3rem] z-20">
        ...
        <div className="flex gap-[1rem] items-center w-[19rem]">
          <img src={logoLight} alt="logo" className="h-[1.6rem]" />
          <h1 className="text-[2rem] font-bold">Kanban</h1>
        </div>

        <h1 className=" text-[1.5rem] font-semibold grid place-items-center translate-x-[-3rem] lg:translate-x-[-11rem] xl:translate-x-[-19rem]">
          Platform Launch
        </h1>
        <div className="flex gap-[1.5rem]">
          <button className="bg-[#635FC7] flex justify-center items-center gap-[0.5rem] w-[10rem] h-[3rem] rounded-full">
            <div>
              <img src={add} alt="" />
            </div>
